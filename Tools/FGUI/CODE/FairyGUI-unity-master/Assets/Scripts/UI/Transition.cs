...
namespace FairyGUI
{
    ...
    public class Transition : ITweenListener
    {
        ...
        public void Play(int times, float delay, float startTime, float endTime, PlayCompleteCallback onComplete,bool reve)
        {
            _Play(times, delay, startTime, endTime, onComplete, reve);
        }
        /// <summary>
        /// 
        /// </summary>
