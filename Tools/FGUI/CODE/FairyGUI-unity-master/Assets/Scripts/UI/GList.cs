...
namespace FairyGUI
{
    ...
    public class GList : GComponent
    {
        ...
        {
            ScrollToView(index, ani, false,0.3f);
        }
        ...
        /// <param name="ani">是否缓动滚动</param>
        /// <param name="tiem">缓动时间</param>
        public void ScrollToView(int index, bool ani,float time)
        {
            ScrollToView(index, ani, false , time);
        }
        ...
        public void ScrollToView(int index, bool ani, bool setFirst,float time)
        {
            if (_virtual)
            {
                if (_numItems == 0)
            ...
            else
            {
                ...
                if (this.scrollPane != null)
                    scrollPane.ScrollToView(obj, ani, setFirst,time);
                else if (parent != null && parent.scrollPane != null)
                    parent.scrollPane.ScrollToView(obj, ani, setFirst,time);
            }
        }
